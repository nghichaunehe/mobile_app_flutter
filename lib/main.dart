...
class _AuthScreenState extends State<AuthScreen> {
  ...
  // URL backend giả định (thay thế bằng URL server thực tế của bạn)
  ...
  void _handleAuth() async {
    ...
    final endpoint = isLogin ? '/signin' : '/createAccount';
    final url = Uri.parse('$_baseUrl$endpoint');
    
    // Giả lập dữ liệu gửi đi (Payload)
    ...
    try {
      ...
      if (response.statusCode == 200) {
        // Thành công: Xử lý phản hồi và chuyển hướng
        final responseData = jsonDecode(response.body);
        print("Phản hồi thành công: $responseData");
        ...
        // TODO: Chuyển hướng người dùng sang HomeScreen hoặc màn hình Dashboard
        // Navigator.pushReplacementNamed(context, '/'); 
        
      } else {
        // Lỗi từ phía server (ví dụ: 400, 401)
      ...
      // Lỗi kết nối mạng, server không phản hồi
      print("Lỗi kết nối: $e");
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text("Không thể kết nối đến server. Vui lòng kiểm tra mạng."),
          backgroundColor: Colors.red,
        ),
      );
    } finally {
        ...
        body: SafeArea(
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                // ... (Phần Header, Logo, Toggle buttons giữ nguyên)
  ...
  // Các hàm/widget hỗ trợ (giữ nguyên)
